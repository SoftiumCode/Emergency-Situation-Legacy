...
class GamePerson {
	...
	check_items() {
		...
		alert(`Опустив свои руки в карманы, проверив все свои сокровенные места, Вы обнаруживаете следующее:\n\n${item_list.join('\n\n')}.`);
	}
...
function start_game() {  
	...
	Act3 = new GameAct({
		...
		texts: [
			{
				type: "text",
				content: "Выбежав на улицу, меня ожидало..."
			},
			{
				type: "text",
